...
def get_processing_time(dataset_path):
    ...
    #do matchingu
    #27 matching time # 28 calculation time # 2 nMatches

    time_per_descriptor = []
    time_per_match = []
    time_per_descriptor =  file_data[1:115,3]/file_data[1:115, 2] #TODO: zapytac Adama co znacza czasy
    time_per_match = ( file_data[1:115,27]/(file_data[1:115,27]) ) / file_data[1:115,27]

    return(detector, descriptor, time_per_descriptor, time_per_match)
